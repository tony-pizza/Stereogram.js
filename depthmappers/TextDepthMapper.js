...
(function () {
  ...
  CanvasTextWrapper.prototype = {
    drawText: function () {
      ...
      if (this.sizeToFill) {
        // starting at 1px increase font size by 1px until text block
        // exceeds the height of its padded container or until words break
        var elementHeight =
          ((this.fitParent === false) ?
            this.canvas.height :
            this.canvas.parentNode.clientHeight) - (this.paddingX * 2);
      ...
      for (var i = 0; i < lines.length; i++) {
        ...
        textPos.y = parseInt(textPos.y, 10) + parseInt(this.lineHeight, 10);
